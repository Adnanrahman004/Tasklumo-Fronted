...
function Profile() {
  ...
  // Page-entry animation state — shows a 2s branded loader before the
  ...
  const rowBtnClass = `bg-gradient-to-br from-[#facc15] to-[#eab308] border-none px-[13px] py-[7px] rounded-[9px] font-bold cursor-pointer text-black text-[10px] whitespace-nowrap transition-all duration-150 hover:-translate-y-0.5 ${FONT}`;
  ...
  const stats = [
    ...
    {
      label: "Withdrawn",
      value: `₹${(profile?.totalWithdrawn || 0).toLocaleString()}`,
    },
    {
      label: "Tasks Done",
      ...
      >
        ...
        <div className="relative z-20 flex justify-between items-center mb-[18px] gap-2">
          <div className="min-w-0">
            <h1 className="text-[clamp(22px,6vw,34px)] font-extrabold bg-gradient-to-r from-[#facc15] to-white bg-clip-text text-transparent m-0 mb-1 truncate">
              Profile
            </h1>
          ...
          <div className="flex items-center gap-2 shrink-0">
            <div className="bg-[#111] border border-[#facc15]/[0.18] px-[11px] py-[7px] rounded-[10px] text-[#ff9d3d] font-bold text-[11px] max-[359px]:text-[10px] max-[359px]:px-2 max-[359px]:py-[5px] flex items-center gap-[5px]">
              <Flame size={13} /> {streak}
            </div>
            <div className="bg-[#111] border border-[#facc15]/[0.18] px-3 py-[7px] rounded-[10px] text-[#facc15] font-bold text-[11px] max-[359px]:text-[10px] max-[359px]:px-2 max-[359px]:py-[5px] flex items-center gap-[5px]">
              <Coins size={13} /> {coins.toLocaleString()}
            </div>
            <button
              aria-label="Menu"
              className="bg-[#111111]/90 border border-[#facc15]/[0.12] w-[38px] h-[38px] rounded-[11px] text-[#facc15] cursor-pointer flex items-center justify-center shrink-0 hover:border-[#facc15]/35 transition-colors"
              ...
              {menuItems.map((item) => {
                ...
                return (
                  <Link
                    ...
                    className="flex items-center gap-2.5 px-3 py-2.5 text-white no-underline text-[12px] rounded-xl transition-colors duration-150 hover:bg-white/5"
                  >
                    <Icon size={15} />
                    {item.label}
                  </Link>
        ...
        <div className="relative z-10 overflow-hidden bg-[#111111]/[0.88] border border-[#facc15]/10 rounded-[22px] px-5 py-6 mb-[14px] backdrop-blur-[18px] text-center animate-[cardIn_0.4s_ease_both]">
          <div className="absolute -top-10 -right-10 w-[150px] h-[150px] rounded-full bg-[radial-gradient(circle,rgba(250,204,21,0.12),transparent_70%)] pointer-events-none" />
        ...
        <div className="relative z-10 grid grid-cols-2 sm:grid-cols-4 gap-[10px] mb-[18px]">
          {stats.map((s, i) => (
            <div
              className="bg-[#111111]/[0.88] border border-[#facc15]/10 rounded-2xl p-[14px] backdrop-blur-[18px] animate-[cardIn_0.4s_ease_both]"
              key={i}
        ...
        <div className="relative z-10 mb-[14px]">
          ...
          <div className="bg-[#111111]/[0.88] border border-[#facc15]/10 rounded-[18px] overflow-hidden backdrop-blur-[18px] animate-[cardIn_0.4s_ease_both]">
            {paymentRows.map((row) => {
              const Icon = row.icon;
              return (
                <div
                  className="flex items-center gap-3 px-4 py-[14px] border-b border-white/[0.04] last:border-b-0"
                  key={row.key}
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[10px] text-[#a1a1aa] m-0 whitespace-nowrap overflow-hidden text-ellipsis">
                      {row.subtitle}
                    </p>
                  </div>
                  {row.action}
        ...
        <div className="relative z-10 mb-[14px]">
          ...
          <div className="bg-[#111111]/[0.88] border border-[#facc15]/10 rounded-[18px] overflow-hidden backdrop-blur-[18px]">
            <div
              className="flex items-center gap-3 px-4 py-[14px] border-b border-white/[0.04] cursor-pointer hover:bg-white/[0.02] transition-colors"
            ...
            <div
              className="flex items-center gap-3 px-4 py-[14px] cursor-pointer hover:bg-white/[0.02] transition-colors"
              onClick={handleReset}
            >
          ...
          >
            ...
            >
              ...
              <div className="flex gap-2.5">
                <button
                  onClick={closePasswordModal}
                  className={`flex-1 bg-white/[0.06] hover:bg-white/[0.1] border-none py-[13px] rounded-xl font-bold cursor-pointer text-white text-[13px] transition-colors duration-150 ${FONT}`}
                >
                  Cancel
                </button>
                <button
