...
function Wallet() {
  ...
  // Page-entry animation state — shows a 1s branded loader before the
  ...
  return (
    <div
      className={`min-h-screen min-h-[100dvh] p-4 pb-[100px] sm:p-5 text-white ${FONT}
      bg-[radial-gradient(circle_at_bottom_left,rgba(255,120,40,0.35),transparent_35%),radial-gradient(circle_at_top_right,rgba(255,140,0,0.22),transparent_28%),linear-gradient(135deg,#050505_0%,#0a0a0a_40%,#120909_100%)]`}
    ...
    >
      ...
      >
        ...
        {/* TOP BAR */}
        <div className="relative z-10 flex justify-between items-center mb-[16px] gap-2.5">
        ...
        {/* BALANCE CARD */}
        <div className="relative z-10 overflow-hidden bg-[#111111]/[0.88] border border-[#facc15]/[0.14] rounded-[22px] px-5 py-[22px] mb-[14px] backdrop-blur-[18px] animate-[cardIn_0.4s_ease_both]">
          <div className="absolute -top-10 -right-10 w-[140px] h-[140px] rounded-full bg-[radial-gradient(circle,rgba(250,204,21,0.12),transparent_70%)] pointer-events-none" />

          <p className="text-[#a1a1aa] text-[11px] m-0 mb-1">Your Coins</p>
          <h1 className="text-[clamp(30px,9vw,52px)] text-[#facc15] m-0 mb-0.5 font-extrabold leading-none">
          ...
          <div className="relative z-[1] flex gap-2 flex-wrap">
            <button
              className={`flex-1 justify-center whitespace-nowrap bg-[#facc15]/[0.08] border border-[#facc15]/[0.18] px-[14px] py-[9px] max-[359px]:px-[10px] max-[359px]:py-2 rounded-[10px] font-bold cursor-pointer text-[#facc15] text-[11px] max-[359px]:text-[10px] flex items-center gap-1.5 ${FONT} transition-all duration-150 hover:-translate-y-0.5 hover:bg-[#facc15]/[0.14]`}
              onClick={() => setShowBankPopup(true)}
            >
              <Building2 size={14} /> {hasBank ? "Bank Saved" : "Add Bank"}
              {hasBank && <CheckCircle size={12} className="text-[#4ade80]" />}
            </button>
            <button
              className={`flex-1 justify-center whitespace-nowrap bg-[#facc15]/[0.08] border border-[#facc15]/[0.18] px-[14px] py-[9px] max-[359px]:px-[10px] max-[359px]:py-2 rounded-[10px] font-bold cursor-pointer text-[#facc15] text-[11px] max-[359px]:text-[10px] flex items-center gap-1.5 ${FONT} transition-all duration-150 hover:-translate-y-0.5 hover:bg-[#facc15]/[0.14]`}
            ...
            <button
              className={`flex-1 justify-center whitespace-nowrap bg-gradient-to-br from-[#facc15] to-[#eab308] border-none px-[14px] py-[9px] max-[359px]:px-[10px] max-[359px]:py-2 rounded-[10px] font-bold cursor-pointer text-black text-[11px] max-[359px]:text-[10px] flex items-center gap-1.5 shadow-[0_0_14px_rgba(250,204,21,0.2)] ${FONT} transition-all duration-150 hover:shadow-[0_4px_18px_rgba(250,204,21,0.3)]`}
        ...
        {(hasUpi || hasBank) && (
          <div className="relative z-10 bg-[#111111]/[0.88] border border-[#facc15]/10 rounded-[18px] p-4 mb-[14px] backdrop-blur-[18px] animate-[cardIn_0.4s_ease_both] flex flex-col gap-2.5">
            {hasUpi && (
              <div className="flex items-center justify-between gap-2">
                ...
                <button
                  ...
                  className="shrink-0 w-8 h-8 rounded-[9px] bg-white/[0.05] hover:bg-white/[0.1] text-[#a1a1aa] hover:text-[#facc15] flex items-center justify-center transition-colors duration-150"
                >
                  {copiedField === "upi" ? (
        ...
        {/* STATS */}
        <div className="stats-grid relative z-10 grid grid-cols-3 gap-[10px] mb-[14px]">
          {/* Today's Earning */}
          <div className="bg-[#111111]/[0.88] border border-[#facc15]/10 rounded-2xl p-[14px] backdrop-blur-[18px] animate-[cardIn_0.4s_ease_both]">
        ...
        {/* HISTORY */}
        <div className="relative z-10 bg-[#111111]/[0.88] border border-[#facc15]/10 rounded-[18px] overflow-hidden p-4 backdrop-blur-[18px] animate-[cardIn_0.4s_ease_both] mb-[14px]">
            ...
            {historyFilters.map((f) => {
              ...
              return (
                <button
                  ...
                  className={`shrink-0 px-3 h-7 rounded-full text-[10.5px] font-bold border transition-colors duration-150 ${FONT} ${
                    isActive
                  ...
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      <p className="text-white text-sm font-semibold truncate">
                        {h.method === "upi" ? "UPI Transfer" : "Bank Transfer"}
                      </p>
            ...
            >
              ...
              {withdrawSuccess ? (
                <div className="text-center pt-2.5 pb-1">
                  ...
                  <button
                    className={`w-full bg-gradient-to-br from-[#facc15] to-[#eab308] border-none py-[13px] rounded-xl font-extrabold cursor-pointer text-black text-[13px] ${FONT}`}
                    onClick={closeWithdraw}
                  >
                    Done
                  </button>
                ...
                <>
                  <div className="flex justify-between items-center mb-[18px]">
                    ...
                    <button
                      className="bg-white/[0.06] border-none w-8 h-8 rounded-[9px] text-[#a1a1aa] cursor-pointer flex items-center justify-center"
                      onClick={closeWithdraw}
                    >
                      <X size={16} />
                    </button>
                  ...
                  <div className="flex bg-white/5 rounded-xl p-[3px] mb-[18px] gap-[3px]">
                    <button
                      className={`flex-1 py-[9px] rounded-[10px] border-none text-[12px] font-semibold cursor-pointer ${FONT} flex items-center justify-center gap-1.5 transition-all duration-200 ${
                        withdrawTab === "upi"
                  ...
                  {withdrawAmount && (
                    <p className="text-[10px] text-[#a1a1aa] -mt-1 mb-3">
                      ...
                      (You have{" "}
                      <span className="text-[#facc15] font-bold">{coins}</span>)
                    </p>
                  )}
                  ...
                  <div className="flex gap-2 mb-3 flex-wrap">
                    {quickAmounts.map((amt) => (
                      <button
                        key={amt}
                        className={`flex-1 whitespace-nowrap text-center px-[10px] py-[7px] rounded-[9px] border text-[11px] max-[359px]:text-[10px] font-bold cursor-pointer ${FONT} transition-colors duration-150 ${
        ...
        {showBankPopup && (
          ...
          >
            ...
            >
              ...
              <div className="flex justify-between items-center mb-[18px]">
                <h2 className="text-[18px] font-bold m-0">Add Bank Account</h2>
              ...
              <button className={popupSaveClass} onClick={handleSaveBank}>
                <Building2 size={15} />
                Save Bank Account
              </button>
            </div>
        ...
        {showUpiPopup && (
          ...
          >
            ...
            >
              ...
              <button className={popupSaveClass} onClick={handleSaveUpi}>
                <Smartphone size={15} />
                Save UPI
              </button>
            </div>
